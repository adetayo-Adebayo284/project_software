...
<html>
	...
	<head>
		...
		<title>Food Ordering and delivery System</title>
	...
	<body>
        ...
        <div class="px-4 py-5 my-5 text-center">
            ...
            <h1 class="display-5 fw-bold">Error: 500 <?php echo $connection; ?></h1>
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4">Error code 500, come back leter.</p>
            </div>
        </div>
