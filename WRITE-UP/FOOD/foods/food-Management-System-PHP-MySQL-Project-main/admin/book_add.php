...
?>
        ...
        <div class="container-fluid px-4 mt-4">
            <form action="functions/process_book_add.php" method="POST" enctype="multipart/form-data">
                <div class=" mb-4">
                    <div class="card-header" style="font-size:18px; text-align: center;">NEW FOOD</div>
                        <div class="card-body">

                            <div class="mb-3">
                                <label class="small mb-1">Name of the Food</label>
                                <input name="book_name" class="form-control" type="text" placeholder="Name of the food">
                            </div>
