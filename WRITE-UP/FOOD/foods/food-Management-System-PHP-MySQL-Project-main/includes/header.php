...
<html>
	...
	<head>
		...
		<title>online food ordering and delivery system</title>
	...
	<body>
		...
		<header class="p-3 text-bg-dark" style="position: sticky;">
    		<div class="container">
      			<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        			...
        			<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
						...
						?>
						<li><a href="book_list.php" class="nav-link px-2 text-white">Foods</a></li>
          				<li><a href="contact.php" class="nav-link px-2 text-white">Contact</a></li>
          				<li><a href="about.php" class="nav-link px-2 text-white">About</a></li>
        			</ul>

					<form method="GET" action="search.php" class="col-12 col-lg-auto text-light mb-3 mb-lg-0 me-lg-3 d-flex align-items-center" 
						role="search"
						placeholder="Search food by any categorie..."
					>
