...
?>
	<table class="table">
		...
		<tr>
			...
			<td><?php echo "N" . $book['book_price']; ?></td>
			<td><?php echo $qty; ?></td>
			<td><?php echo "N" . $qty * $book['book_price']; ?></td>
		</tr>
		<?php } ?>
		<tr>
			<th>&nbsp;</th>
			...
			<th><?php echo "N" . $_SESSION['total_price']; ?></th>
		</tr>
		<tr>
			<td>Shipping</td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<th>&nbsp;</th>
			<th>&nbsp;</th>
			<th><?php echo "N" . ($_SESSION['total_price'] + 200); ?></th>
		</tr>
	</table>
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="card_PID" class="col-lg-2 control-label">PID/CVV</label>
            <div class="col-lg-10">
