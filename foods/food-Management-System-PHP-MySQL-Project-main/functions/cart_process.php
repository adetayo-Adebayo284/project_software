    ...
    function display() 
    {
            ...
            foreach ($_SESSION['cart'] as $id => $value) 
            {
                ...
                echo '
                    <tr>
                        ...
                        <td>' . $value['price'] . '</td>
                        <td>' . $rate . '</td>
                        <td><a class="btn btn-outline-danger" href="../food-Management-System-PHP-MySQL-Project-main/functions/add_to_cart.php?id=' . $id . '">Delete</a></td>
                    </tr>';
        ...
        echo '
            <tr>
                ...
                <td colspan="2">NGN ' . $total_price . ' </td>
            </tr>

            <div align="center" style="margin-top: 20px">
                <input type="submit" value="Re-calculate" class="btn btn-outline-info btn-sm">
                <a class="btn btn-outline-success btn-sm" href="../food-Management-System-PHP-MySQL-Project-main/order.php" name="button" >Confirm & Submit Order</a>     
            </div>';
